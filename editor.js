class RichTextEditor {
    constructor() {
        ...
        this.italicButton.addEventListener('click', () => this.execCommand('italic'));
        this.underlineButton.addEventListener('click', () => this.execCommand('underline'));
        this.imageUpload.addEventListener('change', (e) => this.insertImage(e.target.files));
